    ...
    return (
        <div className="columns is-multiline policy-roll">
            {posts &&
                ...
                const thePath = post.frontmatter.document.absolutePath.replace('opt/build/repo/static/', '')

                    return (
                        <>
                            <div className="is-parent column is-4 is-flex justify-center" key={post.id}>
                                <a href={thePath} className="sponsor is-child blue-text policy-card" target="_blank" rel="noopener noreferrer" download>
